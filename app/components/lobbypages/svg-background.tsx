...
interface SVGBackgroundProps extends React.SVGProps<SVGSVGElement> {
  className?: string
}

const SVGBackground: React.FC<SVGBackgroundProps> = ({ className, ...props }) => (
  <svg viewBox="0 0 1050 407" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
    <path
    ...
    <defs>
      ...
      >
        ...
        <feGaussianBlur stdDeviation={6.15} result="effect1_foregroundBlur_1_1446" />
      </filter>
      <filter
        id="filter1_f_1_1446"
        x={-0.00710773}
